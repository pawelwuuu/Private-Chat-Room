 ...
 * and information that indicates if the message have information for server only (password).
 */
public class Message {
     ...
     * @param containingServerInformation boolean indicating if the message is for server view only.
     */
    ...
    /**
     * Constructs a message object with server view information set to false.
     * @param content string containing content of the message.
     * @param sender string containing nickname of the sender.
     */
